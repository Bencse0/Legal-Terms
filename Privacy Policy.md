# Privacy Policy for Kinetix Studio
 ...
 * Through communications and interactions you have with us directly related to our Games (e.g., bug reports, feedback).
 * From third-party services that may interact with our Games (e.g., Roblox's API).
 ...
 * In-Game Progress and Activity Data: Information about your gameplay, including:
   * Levels completed, quests undertaken, achievements unlocked.
   * Virtual items owned, acquired, or used within our Games.
   * In-game currency (Robux) spent within our Games.
   * Game session duration, timestamps of key actions (e.g., login, logout, specific event triggers).
   * Player statistics, such as scores, playtime, wins/losses, character data.
   * Interactions with non-player characters (NPCs) and game objects.
 * Technical and Device Information (Aggregated/Anonymized via Roblox): While Roblox collects detailed device information, we may receive aggregated, anonymized data about the types of devices, operating systems, or regions from which our Games are accessed for performance analysis.
 ...
 * To Operate and Maintain Our Games:
   ...
   * Tracking your in-game progress, achievements, and virtual item ownership.
   * Processing in-game purchases and ensuring delivery of Virtual Items.
   * Linking your gameplay data to your unique Roblox UserID for continuity.
 * To Improve and Develop Our Games:
   * Analyzing player behavior and engagement to enhance game design, balance, and content.
   * Identifying popular and unpopular features to inform future development decisions.
   * Troubleshooting technical issues, bugs, and crashes.
   * Developing new features, content, and future Games.
 * For Communication:
   * Responding to your support inquiries, feedback, and bug reports.
   * Sending in-game notifications or messages related to game updates, events, or important announcements.
   * Moderating in-game chat to maintain a safe and positive environment.
 * For Safety, Security, and Moderation:
   * Detecting, preventing, and addressing fraud, cheating, exploiting, and other unauthorized activities within our Games.
   * Enforcing our Terms of Service and Roblox Policies.
   * Implementing moderation actions (e.g., muting, temporary bans, permanent bans) in response to policy violations.
   * Protecting the safety and well-being of our players and the integrity of our Games.
 * For Analytics and Research:
   * Performing internal research and analysis to understand demographic trends, player preferences, and game performance.
   * Creating aggregated or anonymized statistical data about our player base.
 ...
 * For Legal Reasons: We may disclose your information if we believe it's necessary to comply with a legal obligation, a court order, or a lawful request from government authorities. We may also disclose information to enforce our Terms of Service, protect our rights, property, or safety, or the rights, property, or safety of our players or others.
 * In Case of Business Transfer: In the event that Kinetix Studio undergoes a merger, acquisition, reorganization, or sale of all or a portion of its assets, your information may be transferred as part of that transaction. We will ensure that the acquiring entity is bound by a privacy policy that protects your information to a comparable extent.
 ...
 * Analytics and Usage Data: Aggregated or anonymized data may be retained indefinitely for long-term trend analysis. Raw, identifiable usage data (where applicable) is retained only as long as necessary for its specific purpose, often aggregated or anonymized shortly after collection.
 ...
 * Right to Erasure ("Right to Be Forgotten"): The right to request the deletion of your personal data under certain conditions. Note that data permanently linked to your Roblox UserID within our game's save data might be difficult to delete without Roblox's involvement or without impacting your game progress.
 * Right to Restriction of Processing: The right to request that we restrict the processing of your data under certain conditions.
 * Right to Data Portability: The right to receive your data in a structured, commonly used, and machine-readable format, and to transmit that data to another controller.
...
Roblox Group Page: [Link to your official Roblox Group Page] (e.g., https://www.roblox.com/groups/YOUR_GROUP_ID_HERE/Kinetix-Studio)
